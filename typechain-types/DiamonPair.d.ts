...
interface DiamonPairInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setFee100(bool)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "fee100", values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "setFee100", values: [boolean]): string;
  ...
  decodeFunctionResult(functionFragment: "fee100", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getReserves",
    data: BytesLike
  ): Result;
...
export class DiamonPair extends BaseContract {
  ...
  functions: {
    ...
    fee100(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  callStatic: {
    ...
    setFee100(_active: boolean, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    fee100(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    fee100(overrides?: CallOverrides): Promise<PopulatedTransaction>;
