...
interface IBKNextCallHelperInterface extends ethers.utils.Interface {
  functions: {
...
export class IBKNextCallHelper extends BaseContract {
  ...
  interface: IBKNextCallHelperInterface;
