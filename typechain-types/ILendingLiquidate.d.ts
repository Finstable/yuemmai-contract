...
interface ILendingLiquidateInterface extends ethers.utils.Interface {
  functions: {
...
export class ILendingLiquidate extends BaseContract {
  ...
  interface: ILendingLiquidateInterface;
