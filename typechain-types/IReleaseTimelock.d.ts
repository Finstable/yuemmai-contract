...
interface IReleaseTimelockInterface extends ethers.utils.Interface {
  functions: {
...
export class IReleaseTimelock extends BaseContract {
  ...
  interface: IReleaseTimelockInterface;
