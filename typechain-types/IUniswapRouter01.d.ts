...
interface IUniswapRouter01Interface extends ethers.utils.Interface {
  functions: {
...
export class IUniswapRouter01 extends BaseContract {
  ...
  interface: IUniswapRouter01Interface;
