...
interface IUniswapRouter02Interface extends ethers.utils.Interface {
  functions: {
...
export class IUniswapRouter02 extends BaseContract {
  ...
  interface: IUniswapRouter02Interface;
