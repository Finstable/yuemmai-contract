...
interface TestDiamonRouterInterface extends ethers.utils.Interface {
  functions: {
...
export class TestDiamonRouter extends BaseContract {
  ...
  interface: TestDiamonRouterInterface;
