...
interface YESControllerErrorReporterInterface extends ethers.utils.Interface {
  functions: {};
...
export class YESControllerErrorReporter extends BaseContract {
  ...
  interface: YESControllerErrorReporterInterface;
